...
<!--    <el-dialog title="设备信息" :visible.sync="vis" width="30%" >
      <el-table :data="devices" border stripe>
        <el-table-column prop="devicename" label="设备名称"></el-table-column>
        <el-table-column prop="type" label="设备类型"></el-table-column>
        <el-table-column prop="times" label="借阅时间"></el-table-column>
      </el-table>
    </el-dialog>-->

<!--    <el-dialog title="设备信息" :visible.sync="stuVis" width="30%" >
      <el-table :data="stuCourses" border stripe>
        <el-table-column prop="name" label="设备名称"></el-table-column>
        <el-table-column prop="equip" label="设备类型"></el-table-column>
        <el-table-column prop="times" label="借阅时间"></el-table-column>
      </el-table>
    </el-dialog>-->
  </div>
