<template>    <!-- 注册页面 -->
  <div class="wrapper">
    <div style="margin: 100px auto; background-color: rgba(0, 0, 0, 0.5); width: 350px; height: 400px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="email">
          <el-input placeholder="邮箱" size="medium" style="margin: 5px 0" prefix-icon="el-icon-lock" show-password v-model="user.email"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        email: [
          { required: true, message: '请输入正确邮箱格式', trigger: 'blur' },
          { min: 1, max: 20, message: '长度在 1 到 20 个字符', trigger: 'blur' }
        ],
      }
    }
